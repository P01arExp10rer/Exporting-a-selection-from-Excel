...
{
    internal sealed class ExcelLaunchForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            // Allow typing sheet name manually (useful if provider can't enumerate sheets).
            ...
            // Row sizing
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 30));  // file
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 30));  // sheet
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 30));  // column
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 240)); // symbols
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 30));  // mode
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 60));  // output
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 30));  // max rows
            table.RowStyles.Add(new RowStyle(SizeType.Percent, 100));
            table.RowStyles.Add(new RowStyle(SizeType.Absolute, 45));  // buttons
